  ...
  landing: {
    ...
    features: {
      organize: {
        ...
        title: "Crear listas de seguimiento",
        description:
          "Crea tu colección personal de películas y series imprescindibles.",
      },
      discover: {
      ...
      share: {
        tagline: "Compartir",
        title: "Sigue las listas de otros usuarios",
        description: "Añade listas de seguimiento a tu espacio personal.",
      },
    },
    startInSeconds: {
