...
export function HeroSection2({ content, trending }: HeroSection2Props) {
  ...
  return (
    <section className="relative min-h-[80vh] overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-background">
      ...
      <div className="relative z-10 flex min-h-[80vh] flex-col items-center justify-center px-4 py-20 text-center">
        ...
        <div className="mb-8 flex flex-wrap items-center justify-center gap-4">
          ...
          <div className="flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-2 backdrop-blur-sm">
            ...
            <span className="text-sm text-gray-300">Partagez avec vos amis</span>
          </div>
          <div className="flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-2 backdrop-blur-sm">
